...
fn test_energy_from_potential_and_vigilance() {
    ...
    let energy = energy_from_potential_and_vigilance(5000, u16::MAX as u32);
    assert_eq!(energy, 5000);

    let energy = energy_from_potential_and_vigilance(u16::MAX as u32, u16::MAX as u32);
    assert_eq!(energy, u16::MAX as u32);
